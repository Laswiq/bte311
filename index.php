...
<form method="post" action="">
  <table> 
    ...
    <tr>
    <td rowspan="2"><input type="submit" value="Tabloyu Oluştur"></td></tr>
    </table>
</form>

<?php
// Kullanıcının girdiği satır ve sütun sayılarını alın
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $satir_sayisi = isset($_POST['satir']) ? intval($_POST['satir']) : 0;
    $sutun_sayisi = isset($_POST['sutun']) ? intval($_POST['sutun']) : 0;

    // Girilen sayılar geçerliyse tabloyu oluştur
